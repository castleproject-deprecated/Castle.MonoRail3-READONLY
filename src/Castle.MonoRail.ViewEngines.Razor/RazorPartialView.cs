...
namespace Castle.MonoRail.ViewEngines.Razor
{
	...
	public class RazorPartialView : IPartialView
	{
		private readonly ViewComponentRenderer viewComponentRenderer;

		public RazorPartialView(IHostingBridge hostingBridge, string view, ViewComponentRenderer viewComponentRenderer)
		{
